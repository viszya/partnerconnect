		...
		<div className={cn(twp().wrapper, "mt-10")}>
			<div className="mx-20 mb-20">
				...
				<article>
					...
					<div className="mt-4 text-primary/80 text-lg">
						<p>
							<span className="text-lg tracking-tighter text-primary">Our Privacy Policy governs the collection, use, and disclosure of user information. By using Sparktup, you consent to our privacy practices outlined in the Privacy Policy.</span>
						</p>
					</div>
				</article>
